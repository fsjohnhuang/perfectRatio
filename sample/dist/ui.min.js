...
var _perfectRatio = __webpack_require__(4);
...
exports.EDGE = exports.IE11 = exports.CHROME = void 0;
...
var ie11r1 = _interopRequireWildcard(__webpack_require__(5));

var ie11r2 = _interopRequireWildcard(__webpack_require__(6));

var chromer1 = _interopRequireWildcard(__webpack_require__(7));

var chromer2 = _interopRequireWildcard(__webpack_require__(8));
...
function _getRatioStatus(ratios, outerWidth, innerWidth, outerHeight, innerHeight, currRatio) {
  ...
  if (isConsoling()) {
    ...
    status = isPerfectInView(ratios, outerWidth, innerWidth, outerHeight, innerHeight, currRatio) ? PERFECT : isZoomIn(outerWidth, innerWidth, currRatio) ? ZOOM_IN : ZOOM_OUT;
  }
...
function isPerfectInView(ratios, outerWidth, innerWidth, outerHeight, innerHeight, ratio) {
  if (!!~ratios.indexOf(ratio)) {
    switch ((0, _utils.getBrowserInfo)()) {
      case _utils.CHROME:
        return (0, _utils.getFullscreen)() ? ratio == 1 ? chromer1.isPerfectInViewFullscreen(outerHeight - innerHeight) : chromer2.isPerfectInViewFullscreen(outerHeight - innerHeight) : ratio == 1 ? chromer1.isPerfectInView(outerWidth - innerWidth) : chromer2.isPerfectInView(outerWidth - innerWidth);

      case _utils.IE11:
        return (0, _utils.getFullscreen)() ? ratio == 1 ? ie11r1.isPerfectInViewFullscreen(outerHeight - innerHeight) : ie11r2.isPerfectInViewFullscreen(outerWidth - innerWidth, outerHeight - innerHeight) : ratio == 1 ? ie11r1.isPerfectInView(outerWidth - innerWidth) : ie11r2.isPerfectInView(outerWidth - innerWidth);
...
function isPerfectInConsole(ratios, ratio, outerWidth, innerWidth, outerHeight, innerHeight) {
  if (!!~ratios.indexOf(ratio)) {
    switch ((0, _utils.getBrowserInfo)()) {
      case _utils.CHROME:
        return (0, _utils.getFullscreen)() ? ratio == 1 ? chromer1.isPerfectInConsoleFullscreen(outerWidth - innerWidth, outerHeight - innerHeight) : chromer2.isPerfectInConsoleFullscreen(outerWidth - innerWidth, outerHeight - innerHeight) : ratio == 1 ? chromer1.isPerfectInConsole(outerWidth - innerWidth, outerHeight - innerHeight) : chromer2.isPerfectInConsole(outerWidth - innerWidth, outerHeight - innerHeight);

      case _utils.IE11:
        return (0, _utils.getFullscreen)() ? ratio == 1 ? ie11r1.isPerfectInConsoleFullscreen(outerWidth - innerWidth, outerHeight - innerHeight) : ie11r2.isPerfectInConsoleFullscreen(outerWidth - innerWidth, outerHeight - innerHeight) : ratio == 1 ? ie11r1.isPerfectInConsole(outerWidth - innerWidth, outerHeight - innerHeight) : ie11r2.isPerfectInConsole(outerWidth - innerWidth, outerHeight - innerHeight);
...
function isZoomIn(outerWidth, innerWidth, ratio) {
  switch ((0, _utils.getBrowserInfo)()) {
    case _utils.CHROME:
      return ratio == 1 ? chromer1.isZoomInInView(outerWidth - innerWidth) : chromer2.isZoomInInView(outerWidth - innerWidth);

    case _utils.IE11:
      return ratio == 1 ? ie11r1.isZoomInInView(outerWidth - innerWidth) : ie11r2.isZoomInInView(outerWidth - innerWidth);
...
function isZoomOut(outerWidth, innerWidth, ratio) {
  switch ((0, _utils.getBrowserInfo)()) {
    case _utils.CHROME:
      return ratio == 1 ? chromer1.isZoomOutInView(outerWidth - innerWidth) : chromer2.isZoomOutInView(outerWidth - innerWidth);

    case _utils.IE11:
      return ratio == 1 ? ie11r1.isZoomOutInView(outerWidth - innerWidth) : ie11r2.isZoomOutInView(outerWidth - innerWidth);
...
exports.isPerfectInView = isPerfectInView;
exports.isPerfectInConsole = isPerfectInConsole;
exports.isPerfectInViewFullscreen = isPerfectInViewFullscreen;
exports.isPerfectInConsoleFullscreen = isPerfectInConsoleFullscreen;
exports.isZoomInInView = isZoomInInView;
exports.isZoomOutInView = isZoomOutInView;
var DWIDTH = 16;
var FULLSCREEN_DHEIGHT = 23;
var MIN_DHEIGHT_IN_CONSOLE = 92;
var MAX_DHEIGHT_IN_CONSOLE = 93;

function isPerfectInView(dw) {
  return dw == DWIDTH;
}

function isPerfectInConsole(dw, dh) {
  return dw == DWIDTH || MIN_DHEIGHT_IN_CONSOLE <= dh && dh <= MAX_DHEIGHT_IN_CONSOLE;
}

function isPerfectInViewFullscreen(dh) {
  return dh == FULLSCREEN_DHEIGHT;
}

function isPerfectInConsoleFullscreen(dw, dh) {
  throw Error();
}

function isZoomInInView(dw) {
  return dw < DWIDTH;
}

function isZoomOutInView(dw) {
  return dw > DWIDTH;
}
...
exports.isZoomOutInView = isZoomOutInView;
var DWIDTH = 13;
var FULLSCREEN_DWIDTH = 0;
var FULLSCREEN_DHEIGHT = 0;
var MIN_DHEIGHT_IN_CONSOLE = 87;
var MAX_DHEIGHT_IN_CONSOLE = 93;
...
function isPerfectInViewFullscreen(dw, dh) {
...
exports.isZoomOutInView = isZoomOutInView;
var DWIDTH = [0, 10];
var DHEIGHT_IN_CONSOLE = [0, 65, 66, 86, 94];
var FULLSCREEN_DWIDTH = 0;
var FULLSCREEN_DHEIGHT = 0;
...
exports.isZoomOutInView = isZoomOutInView;
var DWIDTH = [0, 13, 14];
var DHEIGHT_IN_CONSOLE = [0, 65, 66, 86, 89];
var FULLSCREEN_DWIDTH = 0;
var FULLSCREEN_DHEIGHT = 0;
